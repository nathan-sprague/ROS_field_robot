...
class Robot:
    ...
    def logData(self):
        ...
        while self.notCtrlC:
            ...
            importantVars = [int(time.time()) - self.startTime, self.heading, int(self.targetHeadingAngle),
                             ...
                             self.destinations[0]["coord"][0], self.destinations[0]["coord"][1], self.coords[0],
                             self.coords[1],
                             ]
            msg = ""
    ...
    def pointNavigate(self, destinations):
        ...
        while len(self.destinations) > 0:
            ...
            while self.notCtrlC:
                ...
                if hitDestination and nav_functions.atDestination(self.coords, targetCoords,
                                                                  tolerance=self.gpsAccuracy / 3.28 * 3):
                    ...
                    if destType == "beginRow":
                        while self.destinations[0]["destType"] == "sample" or self.destinations[0][
                            "destType"] == "endRow":
    ...
    def interRowNavigate(self, destination=False):
        ...
        cam = video_navigation.RSCamera(useCamera=True, saveVideo=False,
